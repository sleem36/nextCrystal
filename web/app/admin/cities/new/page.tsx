  ...
  return (
    <div className="container-wide space-y-4 py-8">
      ...
      >
        ...
        <Input name="contact_address" label="Адрес для контактов" placeholder="Правобережный тракт, 26" />
        <Input name="contact_hours" label="Время работы" placeholder="Ежедневно с 9:00 до 20:00" />
        <Input name="contact_phone" label="Телефон" placeholder="+7 (385) 259-03-06" />
        <Input name="contact_email" label="Почта" placeholder="barnaul@aurora-auto.ru" />
        <Input
        ...
        <Textarea
          ...
          label="Фото для галереи (пути; можно оставить пустым)"
